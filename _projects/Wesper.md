...
description: Led firmware, cloud architecture, and backend development for a consumer sleep monitoring device, from prototype -> FDA clearance & mass production.
