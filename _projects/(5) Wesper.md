...
At that time, the company had a functioning demo device & app, but it was not FDA cleared, had no backend aside from an S3 bucket, and the product had yet to be sold to a customer.
