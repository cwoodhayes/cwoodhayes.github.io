...
- Successful launch & subsequent flight analysis of the [Traveler IV spacecraft](/projects/traveler-iv/)
...
- [FlashLog](https://github.com/cwoodhayes/FlashLog-archive) - a memory management layer on top of NOR flash that records telemetry streams, detects bitflip errors from radiation, and supports rapid system state recovery in response to random power outages
